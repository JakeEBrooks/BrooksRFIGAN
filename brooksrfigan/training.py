...
def train(dataset, epochs=10, validation_multi=1, batch_size=32, gen_loss_lambda=100, generator_model=None, discriminator_model=None): #remember to add "dataset" argument
